...
return [
    ...
    'customer_new_order_subject'     => 'Đơn hàng mới {{ order_id }}',
    'order_cancellation_title'       => 'Hủy đơn hàng',
    'order_cancellation_description' => 'Được gửi khi khách hàng hủy đơn hàng',
    'order_cancellation_subject'     => 'Đơn hàng đã được huỷ {{ order_id }}',
    ...
    'delivery_confirmation_subject'     => 'Đơn hàng đang được giao {{ order_id }}',
    ...
    'admin_new_order_subject'     => 'Đơn hàng mới {{ order_id }}',
    ...
    'order_confirmation_subject'     => 'Đơn hàng đã được xác nhận {{ order_id }}',
    ...
    'payment_confirmation_subject'     => 'Đơn hàng đã được xác nhận thanh toán {{ order_id }}',

    'order_recover_title'       => 'Đơn hàng đang chờ hoàn tất',
    'order_recover_description' => 'Email nhắc nhở khách hàng hoàn tất đơn hàng',
    'order_recover_subject'     => 'Đơn hàng đang chờ hoàn tất',
];
