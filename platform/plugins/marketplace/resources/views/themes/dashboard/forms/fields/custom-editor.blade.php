...
@push('scripts')
    <script>
        ...
        var RV_MEDIA_URL = {
            ...
            media_upload_from_editor: '{{ route('marketplace.vendor.upload') }}'
        }
    ...
    <form id="tinymce_form" action="{{ route('marketplace.vendor.upload') }}" target="form_target" method="post" enctype="multipart/form-data" style="width:0;height:0;overflow:hidden;display: none;">
        @csrf
